			...
			<div className="work-section">
				...
				<div className="work-cards">
					<WorkCard
						...
						details={`Neural Network, implemented in Python using numpy and pandas, trained on data from UCI Machine Learning Database to predict
					daily bike rental ridership.`}
						...
						linkImageSrc={require("../images/github.svg")}
					/>
					<WorkCard
					...
					<WorkCard
						...
						details={"React webapp for tracking book reading progress."}
						sourceHref={
